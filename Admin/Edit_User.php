    ...
    *{
    ...
    <div class="text"><small style="font-size: 1rem">Customer ></small>  Edit Customer Details</div>
    <div class="col-md-12">
            <div class="card">
        ...
        <div class="container" style="margin-left: 70px">        
            ...
            src="uploads/<?php echo $result['image']; ?>" alt="" style="max-width: 100px; max-height: 100px;">
        <?php else: ?>
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                            ...
                            <div class="input-field">
                                ...
                                <input type="date" name="bday" value="<?php echo isset($meta['bday']) ? $meta['bday']: '' ?>"  required>
                            </div>
                            ...
                            <div class="input-field">
                                ...
                                <input type="number" name="contact" value="<?php echo isset($meta['contact']) ? $meta['contact']: '' ?>"  required>
                            </div>
                            ...
                            <div class="input-field">
                                <label>Address</label>
                                <input type="text" name="address" value="<?php echo isset($meta['address']) ? $meta['address']: '' ?>"  required>
                            </div>
                        ...
                        <div class="input-field">
                            ...
                            <option <?php if ($meta['category'] == 'Residences') echo 'selected'; ?>>Residences</option>
                            <option <?php if ($meta['category'] == 'Business') echo 'selected'; ?>>Business</option>
                            <option <?php if ($meta['category'] == 'Others') echo 'selected'; ?>>Others</option>
                            </select>
                        </div>
                        ...
                        <div class="input-field">
                                ...
                                <input type="password" name="password" value="<?php echo $result['password']; ?>"  required>
                            </div>
                        
                            <div class="input-field">
                                <label>Confirm Password</label>
                                <input type="password" name="copassword" value="<?php echo $result['copassword']; ?>"  required>
                            </div>
                        

                        <div class="input-field">
                                <label>Image</label>
                                <input style="width: 365px; background-color: #D5D8DC; padding: 6px;" type="file" name="image" value="<?php echo isset($result['image']) ? $result['image']: '' ?>" >
                        </div>

                        <div style="display: flex; justify-content: center; width: 1100px;">
                            <button class="sumbit" name="update">
                            ...
                            <button class="sumbit" style="background-color: gray;">
                                <span class="btnText"><a href="customer.php" style="text-decoration: none; color: white;">
                        Close</span>&nbsp;
