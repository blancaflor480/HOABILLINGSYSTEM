...
if (isset($_POST['update'])) {
    ...
    if ($_FILES["image"]["error"] == 0) {
        ...
        mysqli_query($conn, "UPDATE tableusers SET fname='$fname', mname='$mname', lname='$lname', email='$email', gender='$gender', type='$type', uname='$uname', image='$image_name' WHERE Id = '$Id'") or die(mysqli_error());
    } else {
        // Update the user without changing the image
        mysqli_query($conn, "UPDATE tableusers SET fname='$fname', mname='$mname', lname='$lname', email='$email', gender='$gender', type='$type', uname='$uname' WHERE Id = '$Id'") or die(mysqli_error());
    }
            ...
            <div class="details personal">
                   ...
                   <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="date" value="<?php echo isset($meta['bday']) ? $meta['bday']: '' ?>"  required>
                        </div>

                        <div class="input-field">
                            <label>Email</label>
                            <input type="text" value="<?php echo isset($meta['email']) ? $meta['email']: '' ?>"  required>
                        </div>

                        <div class="input-field">
                            <label>Mobile Number</label>
                            <input type="number" value="<?php echo isset($meta['contact']) ? $meta['contact']: '' ?>"  required>
                        </div>
                        ...
                        <div class="input-field">
                            <label>Address</label>
                            <input type="text" value="<?php echo isset($meta['address']) ? $meta['address']: '' ?>"  required>
                        </div>
                    ...
                    <div class="input-field">
                            <label>Image</label>
                            <input style="width: 1100px; background-color: #D5D8DC; padding: 6px;" type="file" value="<?php echo isset($meta['image']) ? $meta['image']: '' ?>"  required>
                    </div>
